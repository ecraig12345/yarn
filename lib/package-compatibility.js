...
function shouldCheckCpu(cpu, ignorePlatform, ignoreCpu) {
...
function shouldCheck(manifest, options) {
  return shouldCheckCpu(manifest.cpu, options.ignorePlatform, options.ignoreCpu) || shouldCheckPlatform(manifest.os, options.ignorePlatform) || shouldCheckEngines(manifest.engines, options.ignoreEngines);
}