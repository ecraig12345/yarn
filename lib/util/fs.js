...
exports.getFirstSuitableFolder = exports.readFirstAvailableStream = exports.makeTempDir = exports.hardlinksWork = exports.writeFilePreservingEol = exports.getFileSizeOnDisk = exports.walk = exports.symlink = exports.find = exports.readJsonAndFile = exports.readJson = exports.readFileAny = exports.hardlinkBulk = exports.copyBulk = exports.mkdirp = exports.unlink = exports.glob = exports.link = exports.chmod = exports.lstat = exports.exists = exports.stat = exports.access = exports.rename = exports.readdir = exports.realpath = exports.readlink = exports.writeFile = exports.open = exports.readFileBuffer = exports.lockQueue = exports.constants = undefined;
  ...
  var _ref = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (queue, events, possibleExtraneous, reporter) {
    ...
    let build = (() => {
      var _ref5 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (data) {
        ...
        if (type === 'symlink') {
          yield (0, (_mkdirp || _load_mkdirp()).default)((_path || _load_path()).default.dirname(dest));
          onFresh();
        ...
        if (srcStat.isSymbolicLink()) {
          ...
          if (!destStat) {
            ...
            yield (0, (_mkdirp || _load_mkdirp()).default)(dest);
          }
...
let copyBulk = exports.copyBulk = (() => {
  var _ref17 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (queue, reporter, _events) {
    ...
    yield new Promise(function (resolve, reject) {
      const split = fileActions.reduce(function (acc, curr) {
      ...
      split.forEach(function (ac, i) {
        ...
        const onMessage = function onMessage() {
          ...
          ac.forEach(function (a) {
            return events.onProgress(a.dest);
          });
          running -= 1;
          if (running === 0) {
            resolve();
        ...
        const actions = ac.map(function (action) {
          return { src: action.src, dest: action.dest };
        });
        actions.forEach(function (action) {
          return reporter.verbose(reporter.lang('verboseFileCopy', action.src, action.dest, `worker ${i}, total ${actions.length}`));
        });
...
let hardlinkBulk = exports.hardlinkBulk = (() => {
  var _ref18 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (queue, reporter, _events) {
    const events = {
      onStart: _events && _events.onStart || noop,
      onProgress: _events && _events.onProgress || noop,
      possibleExtraneous: _events ? _events.possibleExtraneous : new Set(),
    ...
    yield (_promise || _load_promise()).queue(fileActions, (() => {
      var _ref19 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (data) {
  ...
  return function hardlinkBulk(_x14, _x15, _x16) {
    return _ref18.apply(this, arguments);
  };
})();

let readFileAny = exports.readFileAny = (() => {
  var _ref20 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (files) {
  ...
  return function readFileAny(_x18) {
    return _ref20.apply(this, arguments);
  };
})();

let readJson = exports.readJson = (() => {
  var _ref22 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (loc) {
    return (yield readJsonAndFile(loc)).object;
  });

  return function readJson(_x19) {
...
let readJsonAndFile = exports.readJsonAndFile = (() => {
  ...
  return function readJsonAndFile(_x20) {
    return _ref23.apply(this, arguments);
  };
})();

let find = exports.find = (() => {
  var _ref24 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (filename, dir) {
  ...
  return function find(_x21, _x22) {
    return _ref24.apply(this, arguments);
  };
})();

let symlink = exports.symlink = (() => {
  var _ref25 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (src, dest) {
  ...
  return function symlink(_x23, _x24) {
    return _ref25.apply(this, arguments);
  };
})();

let walk = exports.walk = (() => {
  var _ref26 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (dir, relativeDir, ignoreBasenames = new Set()) {
    let files = [];
  ...
  return function walk(_x25, _x26) {
    return _ref26.apply(this, arguments);
  };
})();

let getFileSizeOnDisk = exports.getFileSizeOnDisk = (() => {
  var _ref28 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (loc) {
    const stat = yield lstat(loc);
  ...
  return function getFileSizeOnDisk(_x27) {
    return _ref28.apply(this, arguments);
  };
})();

let getEolFromFile = (() => {
  var _ref29 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (path) {
  ...
  return function getEolFromFile(_x28) {
    return _ref29.apply(this, arguments);
  };
})();

let writeFilePreservingEol = exports.writeFilePreservingEol = (() => {
  var _ref30 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (path, data) {
  ...
  return function writeFilePreservingEol(_x29, _x30) {
    return _ref30.apply(this, arguments);
  };
})();

let hardlinksWork = exports.hardlinksWork = (() => {
  var _ref31 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (dir) {
  ...
  return function hardlinksWork(_x31) {
...
let makeTempDir = exports.makeTempDir = (() => {
  var _ref32 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (prefix) {
    ...
    yield (0, (_mkdirp || _load_mkdirp()).default)(dir);
    return dir;
  });

  return function makeTempDir(_x32) {
    return _ref32.apply(this, arguments);
  };
})();

let readFirstAvailableStream = exports.readFirstAvailableStream = (() => {
  var _ref33 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (paths) {
  ...
  return function readFirstAvailableStream(_x33) {
    return _ref33.apply(this, arguments);
  };
})();

let getFirstSuitableFolder = exports.getFirstSuitableFolder = (() => {
  var _ref35 = (0, (_asyncToGenerator2 || _load_asyncToGenerator()).default)(function* (paths, mode = constants.W_OK | constants.X_OK) {
    const result = {
      skipped: [],
      folder: null
    };
    ...
    for (var _iterator16 = paths, _isArray16 = Array.isArray(_iterator16), _i16 = 0, _iterator16 = _isArray16 ? _iterator16 : _iterator16[Symbol.iterator]();;) {
      ...
      try {
        yield (0, (_mkdirp || _load_mkdirp()).default)(folder);
  ...
  return function getFirstSuitableFolder(_x34) {
...
exports.mkdirp = (_mkdirp || _load_mkdirp()).default;
...
const numberOfWorkers = process.env.WORKERS_LIMIT ? parseInt(process.env.WORKERS_LIMIT, 10) : Math.ceil((_os || _load_os()).default.cpus().length / 2);
